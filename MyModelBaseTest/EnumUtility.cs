	...
	public static class EnumUtility
	{
		...
		public static bool TryGetEnumAlias(this Enum enumValue, out string alias)
		{
			...
			if(field != null)
			{
				...
				{
					alias = ResourceUtility.GetString(attribute.Alias, field.DeclaringType.Assembly);
					return true;
				}
			}
		...
		public static bool TryGetEnumDescription(this Enum enumValue, out string description)
		{
			...
			if(field != null)
			{
				...
				{
					description = ResourceUtility.GetString(attribute.Description, field.DeclaringType.Assembly);
					return true;
				}
			}
		...
		public static bool TryGetEnumEntry(this Enum enumValue, bool underlyingType, out EnumEntry entry)
		{
			...
			entry = new EnumEntry(field.DeclaringType, field.Name,
								...
								description == null ? null : ResourceUtility.GetString(description.Description, field.DeclaringType.Assembly));
